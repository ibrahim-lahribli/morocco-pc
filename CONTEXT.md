...
- **Engine (pure JS, `src/recommendation/`)** — implemented and covered by unit tests (`npm run test:unit`; 724 tests as of 2026-09-22):
...
- (4) DONE 2026-09-22 — Engine 5a ranking (pure) — `src/recommendation/ranking/` (`rankBuilds`, `TOP_N_PERSISTED`); 724 unit tests pass. Engine 5b persistence (transactional `recommendation_result` rows) is next, BLOCKED on Decision 20.
